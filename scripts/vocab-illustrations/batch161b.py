...
add('inhibition', '手を伸ばしかけたところで、自分でぐっと引きもどす', f'''
{table(300)}
<g transform="translate(470 268)"><ellipse rx="70" ry="20" fill="#fffefd" class="o"/>
  <path d="M-50-10q0-50 50-50t50 50z" class="coralp o"/>
  <circle cx="0" cy="-64" r="10" class="coral o"/></g>
{person(200, 306, 1.25, 1, 'teal', 'blue', 'reach', 'short', 'neutral')}
<g transform="translate(330 190)"><circle r="42" fill="none" stroke="{CRL}" stroke-width="11"/>
  <path d="M-26 0h52" stroke="{CRL}" stroke-width="11" stroke-linecap="round"/></g>
<path d="M300 250q-50 40-100 10" fill="none" class="a" stroke="{VIO}" stroke-width="7" marker-end="url(#ar)"/>
<path d="M382 200h50" fill="none" stroke="{MUTED}" stroke-width="4" stroke-dasharray="9 8"/>''', arrow=True)
