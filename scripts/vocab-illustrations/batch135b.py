...
# 布に格子を描いたら鳥かごになった。格子をやめ、顔を先に描いてから
# 半透明の布を一枚かぶせる。透けて顔が見えることが veil の要点。
add('veil', '薄い布を頭からかけ、顔が透けて見えている', f'''
{table(380)}
{person(300, 380, 1.2, 1, 'violet', 'blue', 'stand', 'bun', 'smile')}
<g transform="translate(300 244)">
  <path d="M-56-58q56-34 112 0 20 100-12 128-44 16-88 0-32-28-12-128z" fill="#fffefd" opacity="0.55"/>
  <path d="M-56-58q56-34 112 0 20 100-12 128-44 16-88 0-32-28-12-128z" fill="none" stroke="{MUTED}" stroke-width="3"/>
  <path d="M-68 70q68 24 136 0" fill="none" stroke="{MUTED}" stroke-width="3"/>
  <path d="M-56-58q56-34 112 0" fill="none" stroke="{MUTED}" stroke-width="5"/>
</g>
<g transform="translate(300 186)">
  <path d="M-52-6h104v12h-104z" class="gold o"/>
  <circle cx="0" cy="-14" r="10" class="goldp o"/>
</g>
<g class="a" marker-end="url(#ar)"><path d="M480 200l-110 40"/></g>''', arrow=True, ground=False)
